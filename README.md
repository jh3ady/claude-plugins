...
| [`impeccable-paper`](plugins/impeccable-paper) | The Impeccable design craft adapted to Paper (paper.design): design-director quality standards, visual-world commitment, critique with heuristic scoring, and refinement playbooks, driven through the Paper MCP server on the canvas instead of code. |
