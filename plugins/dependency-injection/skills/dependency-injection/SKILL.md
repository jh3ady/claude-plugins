...
description: This skill should be used when wiring an object's dependencies, structuring how objects are constructed, choosing between manual wiring (Pure DI) and a DI container, deciding object lifetimes, or reviewing code for DI anti-patterns such as service locators or over-injection, applying dependency injection even when the term is not used.
---
